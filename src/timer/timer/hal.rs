    ...
    pub trait Instance {
        ...
        fn block() -> &'static pac::tim1::RegisterBlock {
            match Self::id() {
                ...
                Timer::TIM3 => unsafe {
                    (pac::TIM3::ptr() as *const pac::tim1::RegisterBlock)
                        .as_ref()
                        .unwrap()
                },
                Timer::TIM14 => unsafe {
                    (pac::TIM14::ptr() as *const pac::tim1::RegisterBlock)
                        .as_ref()
                        .unwrap()
                },
                Timer::TIM16 => unsafe {
                    (pac::TIM16::ptr() as *const pac::tim1::RegisterBlock)
                        .as_ref()
                        .unwrap()
                },
                Timer::TIM17 => unsafe {
                    (pac::TIM17::ptr() as *const pac::tim1::RegisterBlock)
                        .as_ref()
                        .unwrap()
                },
            }
